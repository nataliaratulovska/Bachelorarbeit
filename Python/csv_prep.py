...
def csv_prep(path, newpath):
    ...
    #Bearbeiten der "Suspense" Spalte, hier hat Catma ein random Slash eingebaut und ich finds doof
    def noslashes(text):
        return text.replace("/","")
...
#Hauptgruppe
#csv_prep('annotated csv/catma_editedutf8.csv', 'annotated csv/python_edit.csv')

#Kontrollgruppe
#csv_prep('annotated csv/catma_editedutf8_cg.csv', 'annotated csv/python_edit_cg.csv')
